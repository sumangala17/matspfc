...
dataset_names = ["maze-32-32-2", "den312d", "room-32-32-4",  "empty-16-16"]  # den312d, ht_chantry
...
results_path_parent = "/home/biorobotics/matspfc/nov17/"
...
def create_problem_instances(dataset_name, num_instances=1):
    ...
    for i in range(1, num_instances + 1):
        ...
        for (num_agents, num_targets) in [(10,15), (5,30)]:  #(5,10), (10,15),
            for num_clusters in K:
                ...
                #     print("N_M_K = ", num_agents, num_targets, num_clusters, '___________________________')
                    unit: Unit = call_CBSS_c(starts, dests, targets, tgid, ac_dict, grids, clusters, sz)
                    ...
                    with open(results_path + f"{dataset_name}_N{num_agents}_M{num_targets}_K{num_clusters}_h0_{i}.txt", "w") as f:
                        for line in str(unit.__dict__):
                            f.write(line)
                        # f.write(str(tgid))
